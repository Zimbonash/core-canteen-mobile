        ...
        <View style={styles.section}>
          ...
          <View style={styles.featuredGrid}>
            ...
            >
              ...
              <Text style={styles.featuredName}>Chicken & Rice</Text>
              <Text style={styles.featuredDescription}>
                Grilled chicken with rice and vegetables
              </Text>
              <Text style={styles.featuredPrice}>R12.50</Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={styles.featuredName}>Sadza ne Nyama</Text>
              <Text style={styles.featuredDescription}>
                Traditional Zimbabwean sadza with beef stew
              </Text>
              <Text style={styles.featuredPrice}>R15.00</Text>
            </TouchableOpacity>
          </View>
        </View>
